...
# Models updated 2026-08-26 (verified via OpenRouter /api/v1/models).
PROVIDERS = [
    # ── 海外主流 ──
    ...
    {"id": "anthropic", "name": "Anthropic (Claude)", "base_url": "https://api.anthropic.com/v1",
     "models": ["claude-fable-5", "claude-opus-5", "claude-opus-5-fast", "claude-opus-4-8-fast", "claude-opus-4-8",
                ...
                "claude-sonnet-5", "claude-sonnet-4-6", "claude-haiku-latest", "claude-opus-4", "claude-haiku-4-5"],
     "key_hint": "sk-ant-...", "note": "Claude Fable 5 最新，需 Anthropic API Key",
     "tags": ["hot"]},
    {"id": "openrouter", "name": "OpenRouter (聚合)", "base_url": "https://openrouter.ai/api/v1",
     "models": ["openai/gpt-5.6-sol-pro", "openai/gpt-5.6-sol", "openai/gpt-5.6-luna-pro",
                "openai/gpt-5.5-pro", "openai/gpt-5.5",
                "anthropic/claude-fable-5", "anthropic/claude-opus-5", "anthropic/claude-opus-5-fast",
                "google/gemini-3.7-flash", "google/gemini-3.6-flash", "google/gemini-3.5-flash-lite",
                "deepseek/deepseek-v4-pro", "deepseek/deepseek-v4-pro-0813", "deepseek/deepseek-v4-flash",
                "x-ai/grok-4.6", "x-ai/grok-4.5", "x-ai/grok-4.3", "x-ai/grok-4.20-multi-agent",
                "qwen/qwen3.7-max", "qwen/qwen3.7-plus", "qwen/qwen3.7-flash",
                "meta-llama/llama-4-maverick", "meta-llama/llama-4-scout",
                "moonshotai/kimi-k3", "z-ai/glm-5.3", "z-ai/glm-5.2", "z-ai/glm-5.1",
                "minimax/minimax-m3", "minimax/minimax-m2.7", "mistralai/mistral-large"],
     "key_hint": "sk-or-...", "note": "聚合 100+ 模型，一个 Key 通用",
     "tags": ["hot", "cheap"]},    {"id": "xai", "name": "xAI (Grok)", "base_url": "https://api.x.ai/v1",
     "models": ["grok-4.6", "grok-4.5", "grok-4.3", "grok-4.20", "grok-4.20-multi-agent"],
    ...
    {"id": "zhipu", "name": "智谱 GLM", "base_url": "https://open.bigmodel.cn/api/paas/v4",
     ...
     "tags": ["cn", "hot"]},    {"id": "doubao", "name": "豆包 / 火山引擎", "base_url": "https://ark.cn-beijing.volces.com/api/v3",
    ...
    {"id": "stepfun", "name": "阶跃星辰 (Step)", "base_url": "https://api.stepfun.com/v1",
     ...
     "tags": ["cn", "fast"]},    {"id": "ernie", "name": "文心一言 / 百度", "base_url": "https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop/chat",
    ...
    {"id": "vercel-ai-gateway", "name": "Vercel AI Gateway", "base_url": "https://ai-gateway.vercel.sh/v1",
     "models": ["gpt-5.5", "claude-opus-5", "gemini-3.6-flash"],
...
def save_provider(name, base_url, api_key, model):
    ...
    if base_url != "https://api.openai.com/v1":
        ...
        # Use "chat" for non-OpenAI providers that don't support /v1/responses.
