...
PROVIDERS = [
    ...
    {"id": "anthropic", "name": "Anthropic (Claude)", "base_url": "https://api.anthropic.com/v1",
     "models": ["claude-fable-5", "claude-opus-5", "claude-opus-5-fast", "claude-opus-4-8", "claude-opus-4-7-fast", "claude-opus-4-7",
                "claude-opus-4-6-fast", "claude-opus-4-6", "claude-opus-4-5",
                "claude-sonnet-5", "claude-sonnet-4-6", "claude-opus-4", "claude-haiku-4-5"],
    ...
    {"id": "openrouter", "name": "OpenRouter (聚合)", "base_url": "https://openrouter.ai/api/v1",
     "models": ["openai/gpt-5.5-pro", "openai/gpt-5.5",
                "anthropic/claude-opus-5", "anthropic/claude-opus-5-fast", "anthropic/claude-opus-4.8", "anthropic/claude-opus-4.7",
                "google/gemini-3.6-flash", "google/gemini-3.5-flash", "google/gemini-3.1-pro-preview",
                "deepseek/deepseek-v4-pro", "deepseek/deepseek-v4-flash",
                "x-ai/grok-4.6", "x-ai/grok-4.3", "x-ai/grok-4.20",
                "qwen/qwen3.7-max", "qwen/qwen3.7-plus",
                "meta-llama/llama-4-maverick", "meta-llama/llama-4-scout",
                "moonshotai/kimi-k3", "z-ai/glm-5.1",
     ...
     "models": ["grok-4.6", "grok-4.3", "grok-4.20", "grok-4.20-multi-agent"],
